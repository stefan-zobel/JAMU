...
public final class ZdImplTest {
    ...
    public void testExp() {
        ...
        TestUtils.assertEquals(Zd.One(), Zd.Zero().exp(), 10e-12);
        Zd iPi = Zd.I().mul(new ZdImpl(pi, 0));
        TestUtils.assertEquals(Zd.One().neg(), iPi.exp(), 10e-12);
    }
    ...
    public void testLogInf() {
        TestUtils.assertEquals(new ZdImpl(inf, pi / 2), oneInf().ln(), 10e-12);
        TestUtils.assertEquals(new ZdImpl(inf, -pi / 2), oneNegInf().ln(), 10e-12);
        TestUtils.assertEquals(infZero(), infOne().ln(), 10e-12);
        TestUtils.assertEquals(new ZdImpl(inf, pi), negInfOne().ln(), 10e-12);
        TestUtils.assertEquals(new ZdImpl(inf, pi / 4), infInf().ln(), 10e-12);
        TestUtils.assertEquals(new ZdImpl(inf, -pi / 4), infNegInf().ln(), 10e-12);
        TestUtils.assertEquals(new ZdImpl(inf, 3d * pi / 4), negInfInf().ln(), 10e-12);
        TestUtils.assertEquals(new ZdImpl(inf, -3d * pi / 4), negInfNegInf().ln(), 10e-12);
    }
    ...
    public void testPowZero() {
        ...
        TestUtils.assertEquals(Zd.One(), new ZdImpl(-1, 3).pow(Zd.Zero()), 10e-12);
    }
