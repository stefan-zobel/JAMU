 ...
 * cumbersome code
 */
public interface MatrixDConduct {
     ...
     * @since 1.4.9
     */
    default MatrixD view(int r0, int c0, int r1, int c1) {
        // every MatrixDConduct is a MatrixD
        return Matrices.view((MatrixD) this, r0, c0, r1, c1);
    }
     ...
     * @since 1.4.9
     */
    default MatrixD viewRows(int r0, int r1) {
        MatrixD A = (MatrixD) this;
     ...
     * @since 1.4.9
     */
    default MatrixD viewColumns(int c0, int c1) {
        MatrixD A = (MatrixD) this;
     ...
     * @since 1.3.1
     */
    MatrixD timesTransposed(MatrixD B);
     ...
     * @since 1.3.1
     */
    MatrixD transposedTimes(MatrixD B);
     ...
     * {@code B} row vector) gets added to a copy of this matrix. If
     * {@code B}'s dimension is the same as the dimension of this matrix this
     * operation behaves exactly like {@link #plus(MatrixD)}. Any other
     * dimension of {@code B} is treated as a mismatch and results in an
     * IndexOutOfBoundsException.
     ...
     * @return a copy of this matrix where the row vector {@code B} has been
     *         added as described above
     * @throws IndexOutOfBoundsException
     *             if the dimension of {@code B} doesn't match in the sense
     *             described above
     * @since 1.4.9
     */
    MatrixD plusBroadcastedRowVector(MatrixD B);
     ...
     * @param B
     *            a row vector with dimension {@code (1 x this.numColumns())}
     * @return a copy of this matrix multiplied by the row vector {@code B} as
     *         described above
     * @throws IndexOutOfBoundsException
     *             if the dimension of {@code B} doesn't match in the sense
     *             described above
     * @since 1.4.9
     */
    MatrixD mulBroadcastedRowVector(MatrixD B);
     ...
     * @param B
     *            a row vector with dimension {@code (1 x this.numColumns())}
     * @return a copy of this matrix divided by the row vector {@code B} as
     *         described above
     * @throws IndexOutOfBoundsException
     *             if the dimension of {@code B} doesn't match in the sense
     *             described above
     * @since 1.4.9
     */
    MatrixD divBroadcastedRowVector(MatrixD B);
