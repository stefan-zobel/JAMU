 ...
 */
public interface MatrixF extends MatrixDimensions, MatrixFConduct {
    ...
    /**
     * Set all elements <code>|x<sub>ij</sub>| &le; k * 2<sup>-24</sup> * max</code>
     ...
     * @since 1.4.8
     */
    MatrixF zeroizeSubEpsilonRelativeInplace(int k);
