...
public interface MatrixD extends MatrixDimensions, MatrixDConduct {
     ...
     * @since 1.4.9
     */
    MatrixD mulBroadcastedVectorInplace(MatrixD B);
     ...
     * @since 1.4.9
     */
    MatrixD divBroadcastedVectorInplace(MatrixD B);
     ...
     * behaves exactly like {@link #addInplace(MatrixD)}. Any other dimension of
     ...
     * @since 1.4.9
     */
    MatrixD addBroadcastedRowVectorInplace(MatrixD B);
     ...
     * @since 1.4.9
     */
    MatrixD mulBroadcastedRowVectorInplace(MatrixD B);
     ...
     * @since 1.4.9
     */
    MatrixD divBroadcastedRowVectorInplace(MatrixD B);
