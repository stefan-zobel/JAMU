...
/**
 * Some basic operations for {@link ComplexMatrixF} objects expressed such that
 * the operations' resulting {@code ComplexMatrixF} doesn't have to be supplied
 ...
 * be expressed by more fundamental methods from {@link ComplexMatrixF} leading
 * to more cumbersome code
 */
public interface ComplexMatrixFConduct {
     ...
     * @since 1.2
     */
    ComplexMatrixF selectColumn(int col);
     ...
     * @since 1.4.9
     */
    default ComplexMatrixF view(int r0, int c0, int r1, int c1) {
        // every ComplexMatrixFConduct is a ComplexMatrixF
        return Matrices.view((ComplexMatrixF) this, r0, c0, r1, c1);
    }
     ...
     * @since 1.4.9
     */
    default ComplexMatrixF viewRows(int r0, int r1) {
        ComplexMatrixF A = (ComplexMatrixF) this;
     ...
     * @since 1.4.9
     */
    default ComplexMatrixF viewColumns(int c0, int c1) {
        ComplexMatrixF A = (ComplexMatrixF) this;
     ...
     * @since 1.3
     */
    ComplexMatrixF timesMany(ComplexMatrixF m, ComplexMatrixF... matrices);
     ...
     * @since 1.3.1
     */
    ComplexMatrixF conjugateTransposedTimes(ComplexMatrixF B);
